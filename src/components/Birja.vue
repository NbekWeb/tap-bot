...
<template>
  <div class="flex flex-col h-full pt-6">
    ...
    <div class="pt-2.5 bg-blue-900 grow rounded-t-3xl blue-shadow mt-5">
      <div class="flex flex-col h-full pt-14 bg-dark-200 rounded-t-3xl">
        <div
          class="flex items-center justify-center gap-3 mb-32 text-4xl font-semibold text-white"
        >
        ...
        <div class="relative flex items-end justify-center grow">
          <div
            class="absolute z-10 rounded-full w-80 h-80 circle-outer -top-10 bg-coin"
